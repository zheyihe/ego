 ...
 * Delegates to ego-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   ego -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (ego: ExtensionAPI) {
	ego.registerProvider("gitlab-duo", {
