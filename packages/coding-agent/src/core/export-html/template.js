    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="ego-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="ego-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'ego-share:v1:sidebar-width';
