...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@zheyihe/ego-tui";
...
const THEME_KEY = Symbol.for("@zheyihe/ego-coding-agent:theme");
...
export function getSettingsListTheme(): import("@zheyihe/ego-tui").SettingsListTheme {
	return {
